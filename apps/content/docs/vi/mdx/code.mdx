...
Blog này sử dụng thư viện [`rehype-pretty-code`](https://github.com/atomiks/rehype-pretty-code)
để xử lý code blocks trong các file MDX. Điều này cho phép tùy chỉnh cách hiển thị code một cách linh hoạt!
